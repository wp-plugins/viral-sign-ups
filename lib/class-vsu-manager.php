...
if( ! class_exists( 'VSU_Manager' ) ) {
    ...
    class VSU_Manager{
        ...
        /**
         * Checks the Signup Form page for any sign up submissions occurred. This
        ...
        /**
         * Checks if signup submission has occurred in the page. Should be called
         * before WP 'init' hook.
         * 
        ...
        public function form_submission_occurred() {
            ...
            return true; // submission occurred
        }
