 ...
 * 
 * @return boolean|string False if no errors occured, the error text if an error
 * was found.
 */
...
function vsu_check_signup_action() {
    ...
    if( $signup_action === 'error' ) {
        return array( 'display_error' => __( 'Error occured while signing up. Please try again.', 'viralsignups' ) );
    }
