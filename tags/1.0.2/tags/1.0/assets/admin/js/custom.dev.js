jQuery(document).ready(function(){
    ...
    (function($){
        'use strict';
        var $license_key_field = $('#vsu-admin-form-settings #vsu_admin-settings-license_key');
        $('#vsu-admin-form-settings', $admin_wrap).on('submit', function(e){
            e.preventDefault();
            var $form = $(this);
            show_loader();
            
            $.post(ajaxurl, {
                action: 'vsu_save_settings',
                data: $form.serialize(),
