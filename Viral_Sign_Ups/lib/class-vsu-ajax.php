    ...
    class VSU_Ajax{
        ...
        public static function init() {
            if( current_user_can( 'manage_options' ) ) {
                // save settings for admin "Settings" section
                add_action( 'wp_ajax_vsu_save_settings', array( 'VSU_Ajax', 'save_settings' ) );
...
# Front-End Action Handlers
        ...
        public static function popup_content() {
            ...
            } // error occured while signing up, show the form to try again
...
# Admin Action Handlers   
        ...
        /**
         * Save handler for "Settings" section.
         */
